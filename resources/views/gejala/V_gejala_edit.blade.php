            ...
            <form action="{{ route('gejala_update', $gejala->id_gejala) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" id="keterangan" class="form-control keterangan @error('keterangan') is-invalid @enderror" placeholder="Keterangan"cols="30" rows="5">{{ $gejala->keterangan }}</textarea>
                        @error('keterangan')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>

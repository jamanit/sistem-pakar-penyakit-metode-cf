            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="form-diagnosa" class="mb-4">
                            <form action="{{ route('start_diagnosa_detail') }}" method="POST">
                                ...
                                @if ($diagnosa_details->isNotEmpty())
                                    <button type="submit" class="btn btn-primary"><i class="bi bi-heart-pulse-fill"></i> Mulai Diagnosa</button>
                                @endif
                            </form>
                        </div>

                        <div id="hasil-diagnosa" class="alert alert-info alert-dismissible fade show" role="alert">
                            <b>Kesimpulan</b>
